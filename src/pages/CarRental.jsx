...
import { Users, Fuel, Settings, Snowflake, Star } from 'lucide-react';
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-5 border-t border-b border-neutral-100 py-4 text-sm text-neutral-600">
                    ...
                    <div className="flex items-center gap-2">
                      <Fuel size={15} className="text-brand-secondary" /> {car.fuel.split(' / ')[0]}
                    </div>
                    <div className="flex items-center gap-2">
                      <Settings size={15} className="text-brand-secondary" /> {car.transmission.split(' / ')[0]}
                    </div>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="flex justify-between items-end mt-auto">
                    ...
                    <Link
                      to={`/booking?type=car&carId=${car.id}`}
