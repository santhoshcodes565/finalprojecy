...
const driversData = [
  { name: 'Ramesh Kumar', experience: 12, languages: ['Tamil', 'English', 'Hindi'], rating: 4.9, trips: 450, image: 'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?q=80&w=1000&auto=format&fit=crop', bio: 'An expert in Southern routes with over a decade of safe driving.', phone: '9876543001', licenseNo: 'TN-DL-001' },
  { name: 'Murugan S.', experience: 15, languages: ['Tamil', 'Malayalam', 'English'], rating: 5.0, trips: 620, image: 'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?q=80&w=1000&auto=format&fit=crop', bio: 'Specialist in hill station driving, particularly Ooty and Munnar.', phone: '9876543002', licenseNo: 'TN-DL-002' },
  { name: 'Rajesh Kannan', experience: 8, languages: ['Tamil', 'English'], rating: 4.8, trips: 310, image: 'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?q=80&w=1000&auto=format&fit=crop', bio: 'Knowledgeable about heritage temples across Madurai, Thanjavur, and Rameshwaram.', phone: '9876543003', licenseNo: 'TN-DL-003' },
  { name: 'Dinesh V.', experience: 20, languages: ['Tamil', 'Telugu', 'English'], rating: 4.9, trips: 850, image: 'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?q=80&w=1000&auto=format&fit=crop', bio: 'Most senior driver with an impeccable safety record.', phone: '9876543004', licenseNo: 'TN-DL-004' },
  { name: 'Selvam T.', experience: 5, languages: ['Tamil', 'English', 'Hindi'], rating: 4.7, trips: 180, image: 'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?q=80&w=1000&auto=format&fit=crop', bio: 'Young, professional, and tech-savvy. Perfect for corporate clients.', phone: '9876543005', licenseNo: 'TN-DL-005' },
  { name: 'Anwar Basha', experience: 10, languages: ['Tamil', 'Hindi', 'Urdu'], rating: 4.9, trips: 400, image: 'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?q=80&w=1000&auto=format&fit=crop', bio: 'Familiar with coastal routes to Pondicherry and Kanyakumari.', phone: '9876543006', licenseNo: 'TN-DL-006' },
  { name: 'Karuppasamy', experience: 18, languages: ['Tamil', 'Malayalam'], rating: 5.0, trips: 710, image: 'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?q=80&w=1000&auto=format&fit=crop', bio: 'A legend on the Tamil Nadu tourist circuit.', phone: '9876543007', licenseNo: 'TN-DL-007' },
];
