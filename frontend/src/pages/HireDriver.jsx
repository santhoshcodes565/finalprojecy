                    ...
                    <div className="flex-1 p-8 md:p-10 space-y-6 relative bg-gradient-to-br from-white to-neutral-50">
                      ...
                      <div className="pt-2 grid grid-cols-2 lg:grid-cols-3 gap-3">
                        <Link 
                          ...
                          className="lg:col-span-1 flex items-center justify-center gap-2 py-4 rounded-xl bg-brand-primary text-white font-bold text-sm hover:bg-brand-primary/90 shadow-lg shadow-brand-primary/20 transition-all group/btn"
                        >
                          Hire Now
                        </Link>
                        <button
                          onClick={() => setRatingTarget({ id: driver._id, type: 'driver' })}
                          className="lg:col-span-1 flex items-center justify-center gap-2 py-4 rounded-xl bg-white border border-brand-primary/10 text-brand-primary font-bold text-sm hover:bg-neutral-50 shadow-md transition-all"
                        >
                          ⭐ Rate
                        </button>
                        <a 
      ...
      <section className="py-16 bg-white border-t border-neutral-100">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-extrabold text-brand-primary">Driver Feedback</h2>
            <p className="text-neutral-500 mt-2">See what clients say about our professional drivers</p>
          </div>
          <ReviewsWidget serviceId="all" serviceType="driver" />
        </div>
      </section>
