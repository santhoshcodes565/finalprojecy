...
export default function CarRental() {
  ...
  return (
    <div className="bg-brand-accent min-h-screen">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="flex justify-between items-end mt-auto">
                      ...
                      <div className="flex gap-2">
                        <button
                          onClick={() => setRatingTarget({ id: car._id, type: 'car' })}
                          className="bg-white border border-brand-primary/10 text-brand-primary text-sm font-bold px-4 py-3 rounded-xl shadow-sm hover:bg-neutral-50 transition-all"
                          title="Rate this Car"
                        >
                          ⭐ Rate
                        </button>
      ...
      {/* Fleet Reviews Section */}
      <section className="py-16 border-t border-brand-primary/10 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-extrabold text-brand-primary">Fleet Experiences</h2>
            <p className="text-neutral-500 mt-2">Hear from travelers who chose our premium cars</p>
          </div>
          <ReviewsWidget serviceId="all" serviceType="car" />
        </div>
      </section>
    </div>
  );
